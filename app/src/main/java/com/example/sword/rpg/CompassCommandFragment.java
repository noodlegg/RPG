...
//        unicorn.setScaleType(ImageView.ScaleType.MATRIX);   //required
//        matrix.postRotate((float) graden, (unicorn.getDrawable().getBounds().width()/2)+100, (unicorn.getDrawable().getBounds().height()/2)+100);
//        unicorn.setImageMatrix(matrix);
//
//        if (currentDegree == north){
//            compDetected(0);
//        } else if(currentDegree == east){
//            compDetected(1);
//        }else if (currentDegree == west){
//            compDetected(2);
//        }else if (currentDegree ==south){
//            compDetected(3);
//        }
