...
public class SoloGame extends AppCompatActivity {
    ...
    //    commands.add(new Triplet(new RedTestFragment(), START_WEIGHT, 1D));
     ...
     //   commands.add(new Triplet(new SwipeCommandFragment(), START_WEIGHT, 1D));
       commands.add(new Triplet(new TiltCommandFragment(), START_WEIGHT, 1D));
     //  commands.add(new Triplet(new ShakeCommandFragment(), START_WEIGHT, 1D));
      //  commands.add(new Triplet(new CompassCommandFragment(), START_WEIGHT, 10D));
      //  commands.add(new Triplet(new TapCommandFragment(), START_WEIGHT, 2D));
