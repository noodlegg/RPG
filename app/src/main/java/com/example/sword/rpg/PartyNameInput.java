...
public class PartyNameInput extends AppCompatActivity  {
    Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_party_name_input);

        txt = (EditText) findViewById(R.id.nameField);
        show = (ListView) findViewById(R.id.nameList);
        adapter = new ArrayAdapter<String>(PartyNameInput.this, android.R.layout.simple_list_item_1, addArray);
